 ...
 * { com.taobao.weex.devtools.inspector.elements.android.ViewGroupDescriptor} is deriving from
 * { com.taobao.weex.devtools.inspector.elements.android.ViewDescriptor}). The first problem is that
